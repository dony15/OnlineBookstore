...
<link rel="stylesheet" href="css/main.css" type="text/css" />
	...
	<script type="text/javascript">
        ...
        function onusernamekeyup() {
            ...
            var lognfont = $("#lognfont");
            var url="login";
            $.post(url,{"userInfo":userInfo,"password":password},function (data,status) {
                if (status == "success") {
                    var login = JSON.parse(data);
                    if ("error"==login.role){
                        lognfont.html("账号密码错误");
                        lognfont.css("color","red");
                    }else if("user"==login.role){
                        window.location.href="goproductList1";
					}else if("admin"==login.role){
														...
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="userInfo"
																		type="text" placeholder="用户名/邮箱/手机号" value="dony15"  class="textinput" id="userInfo" />
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input name="password"
																		type="password" placeholder="请输入密码" value="123456Zz@" class="textinput" id="password" />
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	<td colspan="2"
																		...
																		name="image" type="image" onclick="return onusernamekeyup()"
