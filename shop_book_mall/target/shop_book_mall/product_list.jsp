...
<%@ page import="com.dony15.shop.bean.PageInfo" %>
...
<link rel="stylesheet" href="css/main.css" type="text/css" />
	...
	<script type="text/javascript">
		...
		function productlimit(pageno) {
            ...
            xhr.open("get","showProductPage?pageNo="+pageno+"&pageSize=8");
		    xhr.send();
...
%>
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;<a href="goproductList1">全部商品</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>全部</h1>&nbsp;&nbsp;&nbsp;&nbsp;共<%out.print(products.size());%>个商品
								<hr />
